...
Usage:
    # Just inspect keys:
    python examples/convert_jax_model_to_pytorch.py --checkpoint_dir checkpoints/pi05_base --inspect_only
    python examples/convert_jax_model_to_pytorch.py --checkpoint_dir "${OPENPI_DATA_HOME:-$HOME/.cache/openpi}/openpi-assets/checkpoints/pi05_base" --inspect_only

    # Convert to PyTorch:
    python examples/convert_jax_model_to_pytorch.py --checkpoint_dir checkpoints/pi05_base --output_path outputs/pi05_base_pytorch
    python examples/convert_jax_model_to_pytorch.py --checkpoint_dir "${OPENPI_DATA_HOME:-$HOME/.cache/openpi}/openpi-assets/checkpoints/pi05_base" --output_path outputs/pi05_base_pytorch
...
def copy_checkpoint_assets(checkpoint_dir: str, output_path: str) -> None:
    """Copy checkpoint assets to the converted model output, if present."""
...
def convert_pi0_checkpoint(
    ...
    copy_checkpoint_assets(checkpoint_dir, output_path)
